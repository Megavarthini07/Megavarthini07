...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="https://medicaldialogues.in/h-upload/2022/01/21/1600x960_168768-category.jpg" height="220" width="210">
			</div>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-warning" type="button">Add to cart</button></a>
