    ...
    <tr height="50">
      ...
      <td  class="fontkink"><span class="fontkink1" >
        <select name="status" class="fontkink" required="required" >
          <option value="">Select Status</option>
                 <option value="in Process">It is in process</option>
                  <option value="product done">product done</option>
        </select>
        </span></td>
    </tr>
     ...
     <tr style=''>
      ...
      <td class="fontkink" align="justify" ><span class="fontkink">
        <textarea cols="30" rows="5" name="remark"  required="required" ></textarea>
        </span></td>
    </tr>
    <tr>
