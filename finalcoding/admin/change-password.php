...
<label class="control-label" for="basicinput">Enter Current Password</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Enter New Password</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Enter new Password again</label>
<div class="controls">
