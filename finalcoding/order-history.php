...
<form name="cart" method="post">	
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item"><font face="arial">S.no</font></th>
					<th class="cart-description item"><font face="arial">Image</font></th>
					<th class="cart-product-name item"><font face="arial">Product Name</font></th>
			
					<th class="cart-qty item"><font face="arial">Quantity</font></th>
					<th class="cart-sub-total item"><font face="arial">Price</font></th>
					
					<th class="cart-total item"><font face="arial">Grandtotal</font></th>
					<th class="cart-total item"><font face="arial">Payment Method</font></th>
					<th class="cart-description item"><font face="arial">Order Date</font></th>
					<th class="cart-total last-item"><font face="arial">Action</font></th>
				</tr>
			</thead>
